...
import { sendGoalHearingSummaryLineForMemberCode } from "@/lib/goalHearingSummaryLine";
...
export async function POST(req: Request) {
  try {
    ...
    for (const memberCode of memberCodes) {
      results.push(await sendGoalHearingSummaryLineForMemberCode(supabase, { memberCode, dryRun }));
    }
