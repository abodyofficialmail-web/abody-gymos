...
const TRAINER_NAMES = ["ゆうと", "たけはる", "ひろむ", "せいや", "りょう", "こうへい"];
...
const HIRO_OFF = new Set(["2026-09-06", "2026-09-13", "2026-09-20", "2026-09-27"]);
...
const SHUFFLE = [
  ...
  ["2026-09-10", "せいや", "恵比寿", "16:00", "20:00"], ["2026-09-11", "ひろむ", "恵比寿", "16:00", "22:00"],
  ["2026-09-17", "せいや", "恵比寿", "16:00", "20:00"], ["2026-09-18", "せいや", "恵比寿", "16:00", "20:00"],
  ["2026-09-19", "せいや", "恵比寿", "16:00", "20:00"], ["2026-09-25", "せいや", "恵比寿", "16:00", "20:00"],
  ["2026-09-21", "ゆうと", "恵比寿", "16:00", "22:00"],
  ["2026-09-23", "りょう", "新宿", "10:00", "18:00"],
  ["2026-09-07", "ひろむ", "新宿", "10:00", "13:00"], ["2026-09-14", "ひろむ", "新宿", "10:00", "13:00"],
  ["2026-09-18", "ひろむ", "新宿", "10:00", "13:00"], ["2026-09-18", "ひろむ", "新宿", "17:00", "22:00"],
  ["2026-09-19", "ひろむ", "新宿", "10:00", "13:00"], ["2026-09-19", "ひろむ", "新宿", "17:00", "22:00"],
  ["2026-09-26", "ひろむ", "新宿", "10:00", "13:00"], ["2026-09-26", "ひろむ", "新宿", "17:00", "22:00"],
  ["2026-09-29", "ひろむ", "新宿", "10:00", "13:00"], ["2026-09-30", "ひろむ", "新宿", "10:00", "13:00"],
  ["2026-09-30", "ひろむ", "新宿", "17:00", "22:00"],
];
...
function buildRows() {
  ...
  for (const [date, start, end] of RYO_SCHEDULE) {
    rows.push(row(date, start, end, "りょう", "桜木町"));
  }
  ...
  // たけはる 桜木町 9/17-（170h目標）
  const takeSakura = [
    ["2026-09-17", "10:00", "13:00"], ["2026-09-17", "16:00", "22:00"],
    ["2026-09-18", "10:00", "13:00"], ["2026-09-18", "16:00", "22:00"],
    ["2026-09-19", "10:00", "13:00"], ["2026-09-19", "16:00", "22:00"],
    ["2026-09-20", "10:00", "13:00"], ["2026-09-20", "16:00", "22:00"],
    ["2026-09-21", "10:00", "13:00"], ["2026-09-21", "16:00", "21:00"],
    ["2026-09-22", "10:00", "13:00"], ["2026-09-22", "16:00", "22:00"],
    ["2026-09-23", "10:00", "13:00"], ["2026-09-23", "16:00", "22:00"],
    ["2026-09-24", "10:00", "13:00"], ["2026-09-24", "16:00", "22:00"],
    ["2026-09-25", "10:00", "13:00"], ["2026-09-25", "16:00", "22:00"],
    ["2026-09-28", "10:00", "13:00"], ["2026-09-28", "16:00", "22:00"],
    ["2026-09-29", "10:00", "13:00"], ["2026-09-29", "16:00", "22:00"],
    ["2026-09-30", "10:00", "13:00"], ["2026-09-30", "16:00", "22:00"],
  ];
  for (const [date, start, end] of takeSakura) {
    if (TAKE_OFF.has(date)) continue;
    rows.push(row(date, start, end, "たけはる", "桜木町"));
  }

  // ゆうと 恵比寿 9/15-（土曜休・日曜11-16）
  const yutoEbisu = [
    ["2026-09-15", "16:00", "22:00"],
    ["2026-09-16", "11:00", "17:00"], ["2026-09-17", "16:00", "22:00"],
    ["2026-09-18", "10:00", "13:00"], ["2026-09-18", "16:00", "21:00"],
    ["2026-09-19", "16:00", "22:00"],
    ["2026-09-22", "16:00", "22:00"], ["2026-09-23", "11:00", "16:00"],
    ["2026-09-24", "10:00", "15:00"], ["2026-09-25", "10:00", "12:00"], ["2026-09-25", "16:00", "21:00"],
    ["2026-09-28", "11:00", "16:00"], ["2026-09-29", "16:00", "22:00"], ["2026-09-30", "11:00", "17:00"],
  ];
  ...
  const hiromuUeno = [
    ...
    ["2026-09-07", "10:00", "13:00"], ["2026-09-07", "16:00", "21:00"],
    ...
    ["2026-09-12", "10:00", "16:00"], ["2026-09-14", "10:00", "13:00"], ["2026-09-14", "16:00", "20:00"],
    ...
    ["2026-09-20", "10:00", "15:00"],
    ["2026-09-21", "10:00", "13:00"], ["2026-09-21", "16:00", "20:00"],
    ...
    ["2026-09-28", "10:00", "13:00"], ["2026-09-28", "16:00", "20:00"],
  ...
  // りょう 9/23は新宿シャッフル（桜木町指定なし日）のみ上で追加済み
