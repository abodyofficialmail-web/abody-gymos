...
// W2-W3 shuffle: ベース以外の店舗（りょうは指定シフト優先のため新宿は9/23のみ）
const SHUFFLE = [
...
function buildRows() {
  ...
  const takeSakura = [
    ...
    ["2026-09-20", "10:00", "13:00"], ["2026-09-20", "16:00", "21:00"],
  ...
  const yutoEbisu = [
    ...
    ["2026-09-28", "16:00", "20:00"], ["2026-09-30", "11:00", "17:00"],
  ];
  ...
  // 恵比寿 日曜 11-16
  if (!hasShuffle("2026-09-28", "ゆうと") && !YUTO_OFF.has("2026-09-28")) {
    rows.push(row("2026-09-28", "11:00", "16:00", "ゆうと", "恵比寿"));
  }
  ...
  // ひろむ 上野
  const hiromuUeno = [
    ["2026-09-01", "10:00", "16:00"], ["2026-09-03", "10:00", "13:00"], ["2026-09-03", "16:00", "21:00"],
    ["2026-09-04", "10:00", "12:00"], ["2026-09-04", "16:00", "21:00"],
    ["2026-09-07", "16:00", "21:00"], ["2026-09-08", "10:00", "13:00"], ["2026-09-08", "16:00", "20:00"],
